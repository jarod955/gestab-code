...
<div id="supprimer<?= $internaute['inter_id']; ?>" style="visibility: hidden; display: none;">
 <a href="index.php?route=supprCompte&idinter=<?= $internaute['inter_id']; ?>" type="button" class="btn btn-primary">
    ...
    <div>
 <a href="javascript:toggleVisibility('reinitialiser<?= $internaute['inter_id']; ?>')" class="btn btn-primary">
     Reinitialiser
 </a>
</div>
<div id="reinitialiser<?= $internaute['inter_id']; ?>" style="visibility: hidden; display: none;">
 <a href="index.php?route=reiniCompte&idinter=<?= $internaute['inter_id']; ?>" type="button" class="btn btn-primary">
