  ...
  if (isset($_POST['send']))
  {
    ...
    if ($categorie !== false)
    {
      ...
      $requete = $requete."&METHOD=SetExpressCheckout".
          ...
          "&RETURNURL=".urlencode("".$base."index.php?route=traitementPaypal"."&amt=".$_SESSION['achat']['catprix']."&catid=".$_SESSION['achat']['catid']."&evid=".$_SESSION['achat']['evid']."&intid=".$_SESSION['achat']['intid']."&codeid=".$_SESSION['achat']['codeid']).
